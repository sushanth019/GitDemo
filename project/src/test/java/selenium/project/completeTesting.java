...
public class completeTesting {
	private static final org.apache.log4j.Logger logger = LogManager.getLogger(completeTesting.class);
	//private static final org.testng.log4testng.Logger logger = LogManager.getLogger(completeTesting.class);
	...
	public void testMenuItems() {
		...
		logger.info(
				"dragging the mouse on to diiferent items and clicking on them to check if they are working properly");
	...
	public void testHomeItem() {
		...
		// logger.info("Testing the Home Item by clicking on My calender and services to
	...
	public void testHobiies() {
		...
		// logger.info("Now Testing the social media links that are provided in the
		// skills section");
		Actions action = new Actions(driver);
	...
	public void testCustomerIcons() {
		...
		// logger.info("Now Testing My customers by extracting the number of customers
		// and then clicking on each one ");
		Actions action = new Actions(driver);
	...
	public void testViewWebsite() {
		...
		// logger.info("This is to to view the services by clicking on each and looking
	...
	public void calenderTest() {
		...
		driver.findElement(By.name("attendee_email")).sendKeys("bichkunda@sushanth.ca");
